...
MASTER_IP=`docker exec redis_sentinel_1 redis-cli -p 26379 SENTINEL get-master-addr-by-name mymaster | head -1`
...
echo ------------------------------------------------
docker exec redis_sentinel_1 redis-cli -p 26379 info Sentinel
